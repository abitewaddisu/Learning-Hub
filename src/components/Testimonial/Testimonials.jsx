      ...
      <Container>
        <Row>
          <Col lg="10" md="12" className="m-auto">
            <Row className="testimonial__wrapper d-flex justify-content-between align-items-center ">
              <Col lg='6' md='12' className="testimonial__img">
                <img src={img} alt="" className="w-100" />
              </Col>

              <Col lg='6' md='12' className="testimonial__content">
